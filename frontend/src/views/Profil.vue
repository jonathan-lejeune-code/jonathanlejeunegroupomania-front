          ...
          <v-col >
            <v-sheet color="teal  darken-4" class="pa-5">
              ...
              <v-card class="mx-auto pa-2" max-width="50%" min-height="600">
                ...
                <v-card-title >
                  lejeune jonathan{{ posts.username }}
                </v-card-title>

                <v-card-subtitle>
                  jojo291189@hotmail.fr{{ posts.email }} <br />
                  n°1{{ posts.id }} <br />
                  ADMIN{{ posts.isAdmin }} <br />
                </v-card-subtitle>

                <v-card-actions>
                  <v-btn @click="SupProfile" type="submit" class="mx-auto">
                    Supprimer le compte
                  </v-btn>
                </v-card-actions>
              </v-card>
